...
<center>
<a href="https://doc-0c-a4-docs.googleusercontent.com/docs/securesc/6k073m1lsiqe2vooa32ks6mrs48uj5pi/jal6pi03phbb3oduunitil3f6dqahmf6/1619573175000/14867233862106753132/14867233862106753132/1TA7b4TuUub7KtyP_huoUO-TCFpeuyIPa?e=download&authuser=3&nonce=qou0054eoa7ce&user=14867233862106753132&hash=77ns5f4cpmdvkg48id5g5bh5dnvtskcf"><img src="https://i.ibb.co/6gx1V1Y/csv-icon.png" alt="descarga" border="0" width="150"></a>
</center><br>
...
Observa que hemos creado una nueva variable <res>disp_4</res> a partir de nuestros datos, multiplicamos nuestra variable por 2 y es por esto, que cada uno de sus datos realiza la operación que le ordenamos.
...
Nos devuelve un valor numérico redondeado a los dígitos que le digamos. Es lo que podríamos llamar el redondeo clásico.

```{r}
disperound <- disper

# Redondearemos a 2 cifras nuestra variable disper_1
disperound$disp_1 <- round(disperound$disp_1, 2)
# Redondearemos a 1 cifra nuestra variable disper_2
disperound$disp_2 <- round(disperound$disp_2, 1)
# Redondearemos a 0 cifras nuestra variable disper_3
